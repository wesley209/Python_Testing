...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32\test\test_win32gui.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32.test.test_win32gui.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.win32.test.test_win32gui.source.html#l7">
                  <tt><i>7</i> <span class="kn">import</span> <span class="nn">pywin32_testutil</span></tt>
               </a>
            </li>
            </ul>
         </li>
