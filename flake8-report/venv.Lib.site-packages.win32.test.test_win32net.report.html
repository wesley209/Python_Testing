...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32\test\test_win32net.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32.test.test_win32net.source.html">
         ...
         <li>
            <a data-code="F401">
               ...
               <strong>F401:</strong> 'win32netcon' imported but unused
               
            </a>
            <ul class="details">
            <li>
               
               <a href="venv.Lib.site-packages.win32.test.test_win32net.source.html#l4">
                  <tt><i>4</i> <span class="kn">import</span> <span class="nn">win32netcon</span></tt>
               </a>
            </li>
            </ul>
         </li>
