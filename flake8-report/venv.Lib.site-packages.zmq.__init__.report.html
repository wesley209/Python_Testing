...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\zmq\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.zmq.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.zmq.__init__.source.html#l57">
                  <tt><i>57</i> <span class="kn">from</span> <span class="nn">zmq</span> <span class="kn">import</span> <span class="n">sugar</span></tt>
               </a>
            </li>
            </ul>
         </li>
