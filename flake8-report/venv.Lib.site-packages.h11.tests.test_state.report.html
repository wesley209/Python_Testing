...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\h11\tests\test_state.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.h11.tests.test_state.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.h11.tests.test_state.source.html#l3">
                  <tt><i>3</i> <span class="kn">from</span> <span class="nn">.._events</span> <span class="kn">import</span> <span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
