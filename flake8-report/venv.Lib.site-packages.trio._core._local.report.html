...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\trio\_core\_local.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.trio._core._local.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.trio._core._local.source.html#l15">
                  <tt><i>15</i> <span class="k">class</span> <span class="nc">_NoValue</span><span class="p">:</span> <span class="o">...</span></tt>
               </a>
            </li>
            </ul>
         </li>
