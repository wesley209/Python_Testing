...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32comext\axscript\client\error.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32comext.axscript.client.error.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.win32comext.axscript.client.error.source.html#l128">
                  <tt><i>128</i>         <span class="k">except</span><span class="p">:</span>  <span class="c1"># Error extracting traceback info!!!</span></tt>
               </a>
            </li>
            </ul>
         </li>
