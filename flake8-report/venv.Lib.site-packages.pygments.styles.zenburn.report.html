...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\styles\zenburn.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.zenburn.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.zenburn.source.html#l28">
                  <tt><i>28</i>     </tt>
               </a>
            </li>
            </ul>
