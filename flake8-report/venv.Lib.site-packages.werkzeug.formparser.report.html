...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\werkzeug\formparser.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.werkzeug.formparser.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.werkzeug.formparser.source.html#l41">
                  <tt><i>41</i>         <span class="k">def</span> <span class="fm">__call__</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
