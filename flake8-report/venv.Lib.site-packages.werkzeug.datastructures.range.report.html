...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\werkzeug\datastructures\range.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.werkzeug.datastructures.range.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.werkzeug.datastructures.range.source.html#l180">
                  <tt><i>180</i> <span class="kn">from</span> <span class="nn">..</span> <span class="kn">import</span> <span class="n">http</span></tt>
               </a>
            </li>
            </ul>
         </li>
