...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\trio\_core\_tests\test_guest_mode.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.trio._core._tests.test_guest_mode.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.trio._core._tests.test_guest_mode.source.html#l505">
                  <tt><i>505</i>         <span class="k">except</span><span class="p">:</span>  <span class="c1"># pragma: no cover</span></tt>
               </a>
            </li>
            </ul>
         </li>
