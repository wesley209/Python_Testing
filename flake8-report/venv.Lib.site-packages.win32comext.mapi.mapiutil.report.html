...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32comext\mapi\mapiutil.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32comext.mapi.mapiutil.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.win32comext.mapi.mapiutil.source.html#l108">
                  <tt><i>108</i>     <span class="n">rc</span> <span class="o">=</span> <span class="p">[]</span></tt>
               </a>
            </li>
            </ul>
         </li>
