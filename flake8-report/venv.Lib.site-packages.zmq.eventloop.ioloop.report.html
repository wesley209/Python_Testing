...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\zmq\eventloop\ioloop.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.zmq.eventloop.ioloop.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.zmq.eventloop.ioloop.source.html#l27">
                  <tt><i>27</i> <span class="kn">from</span> <span class="nn">tornado.ioloop</span> <span class="kn">import</span> <span class="n">IOLoop</span></tt>
               </a>
            </li>
            </ul>
         </li>
