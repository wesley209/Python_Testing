...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\adodbapi\examples\db_print.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.adodbapi.examples.db_print.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.adodbapi.examples.db_print.source.html#l30">
                  <tt><i>30</i> <span class="kn">import</span> <span class="nn">adodbapi</span> <span class="k">as</span> <span class="nn">db</span></tt>
               </a>
            </li>
            </ul>
         </li>
