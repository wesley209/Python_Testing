...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\werkzeug\sansio\http.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.werkzeug.sansio.http.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.werkzeug.sansio.http.source.html#l171">
                  <tt><i>171</i> <span class="kn">from</span> <span class="nn">..</span> <span class="kn">import</span> <span class="n">datastructures</span> <span class="k">as</span> <span class="n">ds</span></tt>
               </a>
            </li>
            </ul>
         </li>
