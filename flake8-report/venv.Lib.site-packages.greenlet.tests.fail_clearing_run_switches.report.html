...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\greenlet\tests\fail_clearing_run_switches.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.greenlet.tests.fail_clearing_run_switches.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.greenlet.tests.fail_clearing_run_switches.source.html#l16">
