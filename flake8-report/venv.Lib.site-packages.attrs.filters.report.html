...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\attrs\filters.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.attrs.filters.source.html">
         ...
         <li>
            <a data-code="F401">
               ...
               <strong>F401:</strong> 'attr.filters.*' imported but unused
               
            </a>
            <ul class="details">
            <li>
               
               <a href="venv.Lib.site-packages.attrs.filters.source.html#l3">
                  <tt><i>3</i> <span class="kn">from</span> <span class="nn">attr.filters</span> <span class="kn">import</span> <span class="o">*</span>  <span class="c1"># noqa: F403</span></tt>
               </a>
            </li>
            </ul>
         </li>
