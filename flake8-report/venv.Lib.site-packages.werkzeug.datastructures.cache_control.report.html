...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\werkzeug\datastructures\cache_control.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.werkzeug.datastructures.cache_control.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.werkzeug.datastructures.cache_control.source.html#l175">
                  <tt><i>175</i> <span class="kn">from</span> <span class="nn">..</span> <span class="kn">import</span> <span class="n">http</span></tt>
               </a>
            </li>
            </ul>
         </li>
