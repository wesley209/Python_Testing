...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32\test\test_win32guistruct.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32.test.test_win32guistruct.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.win32.test.test_win32guistruct.source.html#l6">
                  <tt><i>6</i> <span class="kn">import</span> <span class="nn">win32gui</span></tt>
               </a>
            </li>
            </ul>
         </li>
