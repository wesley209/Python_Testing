...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\outcome\_util.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.outcome._util.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.outcome._util.source.html#l1">
                  <tt><i>1</i> <span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Dict</span></tt>
               </a>
            </li>
            </ul>
         </li>
