...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pythonwin\pywin\dialogs\login.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pythonwin.pywin.dialogs.login.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pythonwin.pywin.dialogs.login.source.html#l26">
                  <tt><i>26</i> <span class="kn">import</span> <span class="nn">win32api</span></tt>
               </a>
            </li>
            </ul>
         </li>
