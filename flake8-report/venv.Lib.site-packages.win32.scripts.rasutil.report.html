...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\win32\scripts\rasutil.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.win32.scripts.rasutil.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.win32.scripts.rasutil.source.html#l41">
                  <tt><i>41</i>             <span class="n">bValid</span> <span class="o">=</span> <span class="mi">1</span></tt>
               </a>
            </li>
            </ul>
         </li>
