...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\greenlet\tests\test_extension_interface.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.greenlet.tests.test_extension_interface.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.greenlet.tests.test_extension_interface.source.html#l12">
